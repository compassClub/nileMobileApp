...
<<<<<<< HEAD
        selector: 'page-landing',template:/*ion-inline-start:"/Users/nsisk/KEVIN/nileMobileApp/src/pages/landing/landing.html"*/'<!--\n  Generated template for the LandingPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <!-- <ion-navbar>\n    <ion-title>Cool Name</ion-title>\n  </ion-navbar> -->\n\n</ion-header>\n\n\n<ion-content padding>\n\n  <img src="assets/images/nile-brand.png" class="brandLogo">\n\n  <h1>  </h1>\n\n  <button ion-button block (click)="login()" margin-bottom>Login</button>\n  <button ion-button block (click)="register()">Register</button>\n\n  <h1 text-center>or</h1>\n\n  <button ion-button block (click)="tour()">Take a tour.</button>\n\n</ion-content>\n'/*ion-inline-end:"/Users/nsisk/KEVIN/nileMobileApp/src/pages/landing/landing.html"*/,
=======
        selector: 'page-landing',template:/*ion-inline-start:"/Users/kevintowe/Desktop/NILE/nileMobileGitRepo/src/pages/landing/landing.html"*/'<!--\n  Generated template for the LandingPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <!-- <ion-navbar>\n    <ion-title>Cool Name</ion-title>\n  </ion-navbar> -->\n\n</ion-header>\n\n\n<ion-content padding>\n\n  <img src="assets/images/nile-brand.png" class="brandLogo">\n\n  <h1>  </h1>\n\n  <button ion-button block (click)="login()" margin-bottom>Login</button>\n  <button ion-button block (click)="register()">Register</button>\n\n  <h1 text-center>or</h1>\n\n  <button ion-button block (click)="tour()">Take a tour.</button>\n\n</ion-content>\n'/*ion-inline-end:"/Users/kevintowe/Desktop/NILE/nileMobileGitRepo/src/pages/landing/landing.html"*/,
