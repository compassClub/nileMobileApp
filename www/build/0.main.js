...
AddLocationPage = __decorate([
    ...
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["K" /* Component */])({
<<<<<<< HEAD
        selector: 'page-add-location',template:/*ion-inline-start:"/Users/nsisk/KEVIN/nileMobileApp/src/pages/add-location/add-location.html"*/'<!--\n  Generated template for the AddEmployeePage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>Add a Location</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content>\n  <ion-searchbar (ionInput)="searchForLocation($event)"\n    [showCancelButton]="true"\n    (ionClear)="onClear()"\n    placeholder="ex: Address or Place"\n    debounce="400"\n    #input></ion-searchbar>\n\n  <ion-list>\n    <ion-item *ngFor="let place of autocompletePlaces" tappable (click)="chooseItem(place)">\n      {{ place.description }}\n    </ion-item>\n  </ion-list>\n\n\n\n\n</ion-content>\n'/*ion-inline-end:"/Users/nsisk/KEVIN/nileMobileApp/src/pages/add-location/add-location.html"*/,
=======
